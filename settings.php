            ...
            <?php while ($setting = $result->fetch_assoc()): ?>
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="<?php echo htmlspecialchars($setting['link']); ?>" class="btn btn-primary">Go to <?php echo htmlspecialchars($setting['name']); ?></a>
                        <a href="edit_setting.php?id=<?php echo $setting['id']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_setting.php?id=<?php echo $setting['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this setting?')">Delete</a>
                    </div>
                </div>
            <?php endwhile; ?>
        </div>
